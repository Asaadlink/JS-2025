...
formReserva.addEventListener('submit', (evento) => {
    ...
    if (nombre === "" || apellido === "") {
        document.getElementById('errorNombre').textContent = nombre === "" ? "Por favor introduzca un nombre." : "";
        document.getElementById('errorApellido').textContent = apellido === "" ? "Por favor introduzca un apellido." : "";
        return;
    }
